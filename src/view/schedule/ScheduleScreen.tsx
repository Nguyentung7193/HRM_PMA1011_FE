...
import {Schedule, getWeeklySchedule} from '../../service/api/ApiService';
...
const ScheduleScreen = () => {
  ...
  const fetchSchedule = async () => {
    try {
      ...
      const response = await getWeeklySchedule(token);
        ...
        <View key={day.date} style={styles.dayContainer}>
          ...
          <View style={styles.shiftsContainer}>
            ...
            <View style={styles.shiftSection}>
              <Text style={styles.shiftTitle}>Ca sáng</Text>
            ...
            {/* Ca chiều */}
            <View style={styles.shiftSection}>
              <Text style={styles.shiftTitle}>Ca chiều</Text>
