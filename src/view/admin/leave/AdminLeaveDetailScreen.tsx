...
import {LeaveRequestDetail, getLeaveRequestDetailAdmin} from '../../../service/api/ApiService';
import metrics from '../../../constants/metrics';

type Props = NativeStackScreenProps<RootStackParamList, 'AdminLeaveDetailScreen'>;
    ...
    <ScrollView style={styles.container}>
      <View style={styles.card}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.infoText}>Email: {request.employeeId.email}</Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoText}>Tổng số ngày: {request.totalDays}</Text>
          </View>
          <View style={styles.infoRow}>
